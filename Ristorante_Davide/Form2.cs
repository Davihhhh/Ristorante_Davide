    ...
    public partial class Form2 : Form
    {
        ...
        public void ricompattazione()
        {
            if (contaeliminati > 0 || piattiaggiunti > 0)
            {
                ...
                FileStream filename3 = new FileStream(path, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.None);
                FileStream filename4 = new FileStream(path2, FileMode.OpenOrCreate, FileAccess.ReadWrite, FileShare.None);
                sw1 = new StreamWriter(filename3);
                sw1.AutoFlush = true;
                sw2 = new StreamWriter(filename4);
                sw2.AutoFlush = true;
                ...
                File.Move(path, @"./menu1.txt");
                File.Move(@"./tmp.txt", path);
                File.Move(@"./menu1.txt", @"./tmp.txt");
            }
            else
            {
